...
// версия - 74 06.02.2025 - 1738220400 - выключение тестовых выводов сообщений и лишних команд, сокращение времени таймаута в командах
// I2C - до 100 мС, было много (10000,1000), установлено ограничение клавиатуры у мастера в тестере автомат. 
// версия - 75 07.02.2025 - 1738220400 - сокращенно время ожиданий при Slave ... надо проверить
// версия - 76 21.02.2025 - 1738220400 - вернул "медленный" алгоритм работы в АВТОМАТЕ, как в 74, но это и для к
// кристалов STM32F303E - там нет "подвисонов" на I2C поэтому исключены фукции переинициализации i2C в дефайне FixErrI2C();
