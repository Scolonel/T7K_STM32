 ...
 * @}
 */
#define MAX1 546//548//588 15/03/2023 сократим длину цифр и тире на 1 пиксель, итого 22 из 572
                 // 26.04.2023 изменен шрифт представлени€ добавлены буквы A L + 
                 // 11.01.2024 изменены размеры букв, добавлены "—" и "№" размер стал 546 »ћѕ”Ћ№—
#define MAX2 1150//1138 + '(' +')'
