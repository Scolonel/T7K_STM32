...
#define RELEASETIME 1678874400 // начальное время установки релиза 15.03.2023 10:00:00    версия - 41// общие в MAIN и прочее 1673258400
...
enum SubSetting {sTime, sNumF, sLOSSm, sLOSS, sORL, sSCp, sMem, sSWm, sVer};   // установка времени, Номер волокна и признак инкремента, порогов индикации затуханий P1a, мощности источиков, Меню очистки памяти, Переключатель признаков сохранения ORL-Loss-Ln in At.
